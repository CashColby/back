...
<Window 
    ...
    <Window.Resources>
        ...
        <Style x:Key="DiscordButton" TargetType="Button" BasedOn="{StaticResource {x:Type Button}}">
    ...
    <Grid>
        ...
        <Grid Grid.Column="1" Background="#FF252526">
            <StackPanel Margin="10">
                ...
                <Button x:Name="btnDiscord" Content="Join Our Discord" Style="{StaticResource DiscordButton}" Margin="0,5,0,0"/>
                ...
                <!-- Made by Blank footer -->
                <TextBlock Text="Made by Blank" HorizontalAlignment="Right" Margin="0,20,0,0" Foreground="#FF007ACC"/>
            </StackPanel>
        </Grid>
    </Grid>
</Window>
...
function Open-Discord {
    try {
        Start-Process "https://discord.gg/3rrZyn8ryU"
        $txtStatus.Text += "Opening Discord invite link...`n"
    }
    catch {
        $txtStatus.Text += "Failed to open Discord: $_`n"
    }
}
#endregion
